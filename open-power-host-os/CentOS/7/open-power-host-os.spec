...
Requires(post): kernel = 4.13.13-1%{?extraver}.gitba8d215%{dist}
...
%changelog
* Fri Nov 17 2017 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 3.5-3.alpha
